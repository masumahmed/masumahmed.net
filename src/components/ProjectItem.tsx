...
function ProjectItem({ project }: any) {
  const { img, alt, title, description, liveLink, liveText, videoLink, videoText, repoLink, repoText, blogtitle, blogLink } = project;
    ...
    <div className="projectItem">
      ...
      <div className="text">
        ...
        <br />
        {
          ...
          <h4>
            <b>Blog: </b>
            <Link to={blogLink} aria-label="blog link">{blogtitle}</Link>
          </h4>
        }
        {liveLink &&
          <h4>
